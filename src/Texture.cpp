...
Texture::Texture(const Bitmap& bitmap, GLint minFiler, GLint magFiler, GLint wrapMode) :
...
_originalHeight((GLfloat)bitmap.height())
{
	...
	gl::TexParameteri(gl::TEXTURE_2D, gl::TEXTURE_MIN_FILTER, minFiler);
	gl::TexParameteri(gl::TEXTURE_2D, gl::TEXTURE_MAG_FILTER, magFiler);
